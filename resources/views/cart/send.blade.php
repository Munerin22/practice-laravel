...
<div class="panel-heading">お届け先の選択</div>
<div class="panel-body">
@if (session('flash_message'))
<font color="#88bb99">{{session('flash_message')}}</font><br>
@endif

<div><a href="{{route('address.add.form', ['id' => $user_id])}}">新規登録</a>
...
<tr>
<td>
<input id="address" type="radio" name="address" value="{{$address['id']}}">
{{$address['name']}}
</td>
...
<td><a href="{{route('address.edit.form', ['id' => $address['id']])}}">編集</a>|
